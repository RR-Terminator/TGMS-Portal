   ...
   <!-- services section starts  -->
      ...
      <section class="services">
         ...
         <div class="box-container">
            ...
            <div class="box"><a  href="StudentProfile.php">
            ...
            <div class="box"> <a  href="Academic_calender.php">
               <img src="images/icon-2.png" alt="">
               <h3 >view academic Calender</h3>
            </a>            
            </div>

            <div class="box"><a  href="stddocupload.php">
              
               <img src="images/icon-4.png" alt="">
               <h3>upload certificates</h3>
               </a>
            </div>
                <div class="box"> <a href="std_view_docs.php">
               <img src="images/icon-3.png" alt="">
               <h3>View Uploaded Certificates</h3>
               </a>
            </div>
   
            <div class="box">  <a href="stdviewmarks.php">
      ...
      <div class="content">
         ...
         <p>Pillai HOC College of Engineering and Technology will admit, 
            educate and train for engineering graduation, a diverse population of students who
             ...
             professionals from diverse backgrounds whose work give them visibility beyond the classroom
             and who are committed to making a significa
             nt difference in the lives of their students a
             nd the community.</p>
