...
$conn = mysqli_connect($sname, $unmae, $password, $db_name);
 if(isset($_POST['send'])){
   ...
   $pass = $_POST['Password'];
   $id;
   $query = "select * from  signinfo  where SUname = '$uname'";
   $q2= "select * from  signinfo  where id = '$id'";
   $result = mysqli_query($conn, $query);
   $login = false;

   if($row = mysqli_fetch_assoc($result)){
      $db_password = $row['Spassword'];
...
<!DOCTYPE html>
   ...
   <h1 class="heading-title">Students login!</h1>

      <form action="std_login.php" method="post" class="book-form">
