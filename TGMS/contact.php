   ...
   if(isset($_POST['send'])){
      ...
      $sql_query = "INSERT INTO `contact us`(`Addno`, `Dept`, `Name`, `email`, `phone`, `Academicyear`, `Desscription`) 
       VALUES ('$addno','$dept','$name','$email','$phone',' $accyear','$descrpt')";
   ...
   <section class="booking">
      ...
      <form action="contact.php" method="post" class="book-form">
         ...
         <div class="inputBox">
               ...
               <input type="text" placeholder="enter your admission no." name="addno">
            </div>

            <div class="inputBox">
               <span>dept:</span>
               <input type="text" placeholder="enter your department" name="depart">
            </div>
            ...
            <div class="inputBox">
               ...
               <input type="date" name="accyear">
            </div>

              <div class="inputBox">
               <span>How Can We Help You ?</span>
               <input type="text" placeholder="enter your number" name="descrpt">
            </div>
